...
const FORMATIONS: FormationDefinition[] = [
  {
    ...
    slots: [
      ...
      { id: 'lcm', label: 'MC', x: 29, y: 51, positions: ['MC'] },
      { id: 'dm', label: 'MCD', x: 50, y: 59, positions: ['MCD'] },
      { id: 'rcm', label: 'MC', x: 71, y: 51, positions: ['MC'] },
      { id: 'lw', label: 'EI', x: 18, y: 28, positions: ['EI'] },
      { id: 'st', label: 'DC', x: 50, y: 20, positions: ['DC', 'SD'] },
      { id: 'rw', label: 'ED', x: 82, y: 28, positions: ['ED'] },
    ],
  },
  {
    id: '4-4-2',
    ...
    slots: [
      ...
      { id: 'rcb', label: 'DFC', x: 64, y: 73, positions: ['DFC', 'DF'] },
      { id: 'rb', label: 'LD', x: 84, y: 72, positions: ['LD'] },
      { id: 'lm', label: 'MI', x: 16, y: 47, positions: ['MI'] },
      { id: 'lcm', label: 'MC', x: 36, y: 50, positions: ['MC'] },
      { id: 'rcm', label: 'MC', x: 64, y: 50, positions: ['MC'] },
      { id: 'rm', label: 'MD', x: 84, y: 47, positions: ['MD'] },
      { id: 'stl', label: 'DC', x: 38, y: 19, positions: ['DC', 'SD'] },
      { id: 'str', label: 'DC', x: 62, y: 19, positions: ['DC', 'SD'] },
    ],
  },
  {
    id: '4-2-3-1',
  ...
  },
  {
    ...
    slots: [
      ...
      { id: 'rcb', label: 'DFC', x: 64, y: 73, positions: ['DFC', 'DF'] },
      { id: 'rb', label: 'LD', x: 84, y: 72, positions: ['LD'] },
      { id: 'dm', label: 'MCD', x: 50, y: 58, positions: ['MCD'] },
      { id: 'lm', label: 'MI', x: 16, y: 43, positions: ['MI'] },
      { id: 'lcm', label: 'MC', x: 39, y: 39, positions: ['MC'] },
      { id: 'rcm', label: 'MC', x: 61, y: 39, positions: ['MC'] },
      { id: 'rm', label: 'MD', x: 84, y: 43, positions: ['MD'] },
  ...
  },
  {
    ...
    slots: [
      { id: 'gk', label: 'POR', x: 50, y: 89, positions: ['POR'] },
      { id: 'lcb', label: 'DFC', x: 24, y: 71, positions: ['DFC', 'DF'] },
      { id: 'cb', label: 'DFC', x: 50, y: 70, positions: ['DFC', 'DF'] },
      { id: 'rcb', label: 'DFC', x: 76, y: 71, positions: ['DFC', 'DF'] },
      { id: 'lwb', label: 'CARR', x: 14, y: 42, positions: ['CARR', 'MI'] },
      { id: 'lcm', label: 'MC', x: 38, y: 51, positions: ['MC'] },
      { id: 'mco', label: 'MCO', x: 50, y: 35, positions: ['MCO'] },
      { id: 'rcm', label: 'MC', x: 62, y: 51, positions: ['MC'] },
      { id: 'rwb', label: 'CARR', x: 86, y: 42, positions: ['CARR', 'MD'] },
      { id: 'stl', label: 'DC', x: 37, y: 19, positions: ['DC', 'SD'] },
      { id: 'str', label: 'DC', x: 63, y: 19, positions: ['DC', 'SD'] },
    ],
  },
  {
    id: '3-4-3',
    ...
    slots: [
      ...
      { id: 'cb', label: 'DFC', x: 50, y: 70, positions: ['DFC', 'DF'] },
      { id: 'rcb', label: 'DFC', x: 76, y: 71, positions: ['DFC', 'DF'] },
      { id: 'lm', label: 'MI', x: 18, y: 44, positions: ['MI'] },
      { id: 'lcm', label: 'MC', x: 40, y: 48, positions: ['MC'] },
      { id: 'rcm', label: 'MC', x: 60, y: 48, positions: ['MC'] },
      { id: 'rm', label: 'MD', x: 82, y: 44, positions: ['MD'] },
      { id: 'lw', label: 'EI', x: 26, y: 24, positions: ['EI'] },
      { id: 'st', label: 'DC', x: 50, y: 18, positions: ['DC', 'SD'] },
      { id: 'rw', label: 'ED', x: 74, y: 24, positions: ['ED'] },
    ],
  },
];
